...
<h1 style="margin: auto; width: 80%; text-align: center;">Signup</h1>

<br>

	<form:form method="post" action="${pageContext.request.contextPath}/signuptodb" modelAttribute="signup" style="margin: auto; width: 80%; text-align: center;">
