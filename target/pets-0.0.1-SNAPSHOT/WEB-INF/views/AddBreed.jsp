...
<form:form method="post" action="${pageContext.request.contextPath}/AddBreedToDB" modelAttribute="Breed" style="margin: auto; width: 80%; text-align: center;" enctype="multipart/form-data">

	<form:input path="name" type="text" class="form-control" placeholder="Breed's Name" />
	
	<br>
	
	<form:input path="average_weight" type="text" class="form-control" placeholder="Breed's average_weight"/>

	<br>
	
	<form:input path="price" type="text" class="form-control" placeholder="Breed's Price"/>
