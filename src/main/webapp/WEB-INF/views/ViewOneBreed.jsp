...
<form action="${pageContext.request.contextPath}/AddCartToDB" method="post">
		...
		<input type="hidden" value="${Breed.getId()}" name="id">
		<br>
		<br>
		<input type="number" placeholder="Quantity" class="form-control" max="1" min="0" name="qty" style="margin: auto;  width: 10%; text-align: center;">
		<br>    
